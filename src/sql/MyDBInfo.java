...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108hzheng1";
	public static final String MYSQL_PASSWORD = "peishiub";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_hzheng1";
